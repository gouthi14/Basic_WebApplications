...
public class PersonService 
{
	...
	public void add(String firstName,String lastName,String email,String password, String confirmpassword,String project)
	{
		logger.debug("Adding new Person");
		String sql="insert into EDetails (firstName,lastName,email,password,confirmpassword,project)values"+"(:firstName,:lastName,:email,:password,:confirmpassword,:project)";
	...
	parameters.put("conformpassword",confirmpassword);
